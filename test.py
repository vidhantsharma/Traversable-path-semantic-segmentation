...
from src.model import SimpleSegmentationCNN, UNetResNet
import os
...
# Load the checkpoint
checkpoint_path = r"checkpoints\uresnet_model.pth"  # Change this to your checkpoint path
...
def preprocess_image(image_path):
    ...
    img = img / 255.0  # Normalize to [0,1] # TODO : check this
